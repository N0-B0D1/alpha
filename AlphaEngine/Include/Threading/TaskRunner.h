...
namespace alpha
{
    ...
    public:
         ...
         */
        explicit TaskRunner(const bool * const running, std::shared_ptr<ConcurrentQueue<ATask *> > pTaskQueue, std::shared_ptr<ConcurrentQueue<ATask *> > pReturnQueue);
        virtual ~TaskRunner();
    ...
    private:
        ...
        std::shared_ptr<ConcurrentQueue<ATask *> > m_pTaskQueue;
